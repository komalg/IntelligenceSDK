...
public class IdentityUpdateInstallationTask extends IntelligenceTask {
    ...
    public IdentityUpdateInstallationTask(IdentityModule identity, Installation installation, TaskListener taskListener) {
        super(taskListener);
        mIdentity = identity;
    ...
    void execute() throws Exception {
        ...
        Response response = mIdentity.createUpdateInstallationRequest(mInstallation).execute();
